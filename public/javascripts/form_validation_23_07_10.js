...
function notarized_documents_count_valid()
{
     var selVal = document.getElementById("notary_notarize_loan_documents").value;
    if(selVal=="Yes")
        {
          //  document.getElementById("notarized_documents_count_field").style.display = "";
            document.getElementById("notarized_documents_count_label").style.display = "";
         }
     else
         {
            ...
            //document.getElementById("notarized_documents_count_field").style.display = "none";
        }
}

function notarized_bilingual_valid()
{
     var selVal = document.getElementById("notary_bilingual").value;
    if(selVal=="Yes")
        {
            document.getElementById("notarized_bilingual_label").style.display = "";
     ...
     else
         {
          ...
          //  document.getElementById("notarized_bilingual_field").style.display = "none";
        }
}
...
function displayAddress(title) {
//alert(title);
//alert(label);
//alert(field);
		document.getElementById("weekdayAddressTitle").style.display = "none"
		document.getElementById("weekendAddressTitle").style.display = "none"
		document.getElementById("paymentAddressTitle").style.display = "none"
...
function terms()
{
    onsubmit1 = true;
    var error = "<ul>"
    if (trim( document.getElementById('order_order_notary_fee').value)== 0) {
       error += "<li>Enter Notary Fee</li>"
       	   onsubmit1 = false;
    }
    if (document.getElementById('agree').checked==false || document.getElementById('agree1').checked==false || document.getElementById('agree2').checked==false) {
       error += "<li>Please check all below boxes</li>"
       	   onsubmit1 = false;
    }
