...
class Client::OrdersController < ApplicationController
  ...
  def index
   ...
   sort_by = {
    ...
    @refuse_to_sign_orders  = Order.paginate :page => params[:page], :per_page => per_page, :conditions => ["(cancel_order_date IS NOT NULL or admin_order_cancel != '') AND move_to_order_history_by_admin=false"], :order => "updated_at DESC"
